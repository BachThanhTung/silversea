...
<section class="py-5">
    <div class="container-fluid row">
        ...
        <div class="col-md-3 border-right mb-2 pb-3">
            <h3><b>Thể loại phụ</b></h3>
            <div class="list-group">
                <a href="./?p=products&c=<?php echo $_GET['c'] ?>" class="list-group-item <?php echo !isset($_GET['s']) ? "active" : "" ?>">Tất cả</a>
                <?php 
            ...
            <div class="row gx-2 gx-lg-2 row-cols-1 row-cols-md-3 row-cols-xl-4">
                    ...
                    <?php 
                        if($products->num_rows <= 0){
                            echo "<h4 class='text-center'><b>Không có sản phẩm nào trong danh sách.</b></h4>";
                        }
                    ?>
                </div>
            </div>
