                ...
                <div class="row row-col-1 justify-content-center">
                    ...
                    <div class="form-group d-flex pl-2">
                        <div class="custom-control custom-radio">
                          ...
                          <label for="customRadio4" class="custom-control-label">Để giao hàng</label>
                        </div>
                        <div class="custom-control custom-radio ml-3">
                          ...
                          <label for="customRadio5" class="custom-control-label">Để nhận hàng</label>
                        </div>
                      </div>
                        ...
                        <h4 class="text-muted">Phương thức thanh toán</h4>
                            <div class="d-flex w-100 justify-content-between">
                                <button class="btn btn-flat btn-dark">Nhận tiền mặt khi giao hàng</button>
...
paypal.Button.render({
    ...
    onAuthorize: function(data, actions) {
        return actions.payment.execute().then(function(payment) {
    		...
    		// swal('Cảm ơn', 'Thanh toán paypal thành công.', 'success');
            payment_online()
        });
    },
