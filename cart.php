    ...
    <div class="container">
        <div class="row">
            <div class="col d-flex justify-content-end mb-2">
                <button class="btn btn-outline-dark btn-flat btn-sm" type="button" id="empty_cart">Xóa tất cả giỏ hàng</button>
            </div>
        </div>
        <div class="card rounded-0">
            <div class="card-body">
                    ...
                    <div class="d-flex w-100 justify-content-between  mb-2 py-2 border-bottom cart-item">
                        <div class="d-flex align-items-center col-8">
                            ...
                            <div>
                                ...
                                <p class="mb-1 mb-sm-1"><small><b>Giá sản phẩm:</b> <span class="price"><?php echo number_format($row['price']) ?></span></small></p>
                                <div>
                ...
                <div class="d-flex w-100 justify-content-between mb-2 py-2 border-bottom">
                    <div class="col-8 d-flex justify-content-end"><h4>Tổng giá sản phẩm:</h4></div>
...
<script>
    ...
    $(function(){
        ...
        $('#empty_cart').click(function(){
            // empty_cart()
            _conf("Bạn có chắc muốn xóa toàn bộ sản phẩm trong giỏ hàng?",'empty_cart',[])
        })
        $('.rem_item').click(function(){
            _conf("Bạn có chắc muốn xóa sản phẩm này khỏi giỏ hàng?",'rem_item',[$(this).attr('data-id')])
        })
    })
</script>