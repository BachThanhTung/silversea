            ...
            <div class="container-fluid px-4 px-lg-5 ">
                ...
                <form class="form-inline" id="search-form">
                  <div class="input-group">
                    <input class="form-control form-control-sm form " type="search" placeholder="Tìm kiếm" aria-label="Tìm kiếm" name="search"  value="<?php echo isset($_GET['search']) ? $_GET['search'] : "" ?>"  aria-describedby="button-addon2">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <?php endwhile; ?>
                        <?php if($count_cats > 3): ?>
                        <li class="nav-item"><a class="nav-link text-white" href="./?p=view_categories">Tất cả</a></li>
                        <?php endif; ?>
                        <li class="nav-item"><a class="nav-link text-white" href="./?p=about">Về chúng tôi</a></li>
                    </ul>
                    <div class="d-flex align-items-center">
                      <?php if(!isset($_SESSION['userdata']['id'])): ?>
                        ...
                        <a class="text-dark mr-2 nav-link text-white" href="./?p=cart">
                            ...
                            <a href="./?p=my_account" class="text-dark  nav-link text-white"><b> Xin chào, <?php echo $_settings->userdata('firstname')?>!</b></a>
