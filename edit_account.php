        ...
        <div class="card rounded-0">
            <div class="card-body">
                <div class="w-100 justify-content-between d-flex">
                    <h4><b>Cập nhật thông tin chi tiết của tài khoản</b></h4>
                    <a href="./?p=my_account" class="btn btn btn-default btn-flat bg-maroon"><div class="fa fa-angle-left"></div>Trở về danh sách đơn hàng</a>
                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="id" value="<?php echo $_settings->userdata('id') ?>">
                            ...
                            <div class="form-group">
                                <label for="" class="control-label">Liên lạc</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" class="form-control form" value="" placeholder="(Nhập để thay đổi mật khẩu)">
                            </div>
                            <div class="form-group">
                                <label for="cpassword" class="control-label">Mật khẩu hiện tại</label>
                                <input type="password" name="cpassword" class="form-control form" value="" placeholder="(Nhập để thay đổi mật khẩu)">
                            </div>
