...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Kho hàng</h3>
	</div>
	<div class="card-body">
		<form action="" id="inventory-form">
            ...
            <div class="form-group">
				<label for="quantity" class="control-label">Số lượng ban đầu</label>
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=inventory">Đóng</a>
	</div>
</div>
<script>
