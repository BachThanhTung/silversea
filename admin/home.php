...
<div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Tổng số lượng hàng tồn kho</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Các đơn hàng chưa giải quyết</span>
                <span class="info-box-number">
                  <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Tổng số tiền bán hàng hôm nay</span>
                <span class="info-box-number">
                <?php 
