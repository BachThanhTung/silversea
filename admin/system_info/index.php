...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="" class="control-label">Về chúng tôi</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Chính sách riêng tư</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Bìa trang web</label>
				<div class="custom-file">
			...
			<div class="form-group">
				<label for="" class="control-label">Hình ảnh các bannner</label>
				<div class="custom-file">
	              <input type="file" class="custom-file-input rounded-circle" id="customFile" name="banners[]" multiple accept=".png,.jpg,.jpeg" onchange="displayImg(this,$(this))">
	              <label class="custom-file-label" for="customFile">Chọn tệp tin</label>
	            </div>
				<small><i>Chộn đăng hình ảnh cho các banner</i></small>
			</div>
			<?php 
