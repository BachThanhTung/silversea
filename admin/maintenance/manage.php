...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?>Tạo bưu kiện</h3>
	</div>
	<div class="card-body">
		<form action="" id="package-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="title" class="control-label">Tiêu đề bưu kiện</label>
                <textarea name="title" id="" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($title) ? $title : ''; ?></textarea>
			</div>
            <div class="form-group">
				<label for="tour_location" class="control-label">Nơi lưu trữ</label>
            ...
            <div class="form-group">
				<label for="cost" class="control-label">Giá sản phẩm</label>
            ...
            <div class="form-group">
                ...
                <option value="1" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>>Xử lí</option>
                <option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>Chưa xử lí</option>
                </select>
			</div>
            <div class="form-group">
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=responses">Đóng</a>
	</div>
</div>
<script>
