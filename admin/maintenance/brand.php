...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Danh sách các thương hiệu</h3>
...
<script>
	$(document).ready(function(){
		...
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Update Brand Detailes","maintenance/manage_brand.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
