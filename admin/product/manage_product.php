...
<div class="card card-outline card-info">
	...
	<div class="card-body">
		<form action="" id="product-form">
            ...
            <div class="form-group">
				<label for="sub_category_id" class="control-label">Thể loại phụ</label>
                <select name="sub_category_id" id="sub_category_id" class="custom-select">
                <option value="" selected="" disabled="">Chọn thể loại trước</option>
                <?php
            ...
            <div class="form-group">
				<label for="specs" class="control-label">Mô tả</label>
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=product">Thoát</a>
	</div>
</div>
<script>
