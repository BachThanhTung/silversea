    ...
    <div class="container px-4 px-lg-5 my-5">
        ...
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <div class="fs-5 mb-5">
                Giá sản phẩm &#8363; <span id="price"><?php echo number_format($inv[0]['price']) ?></span>
                <br>
                <span><small><b>Số hàng tồn kho</b> <span id="avail"><?php echo $inv[0]['quantity'] ?></span></small></span>
                <br>
                <small>Đánh vào số lượng sản phẩm mà bạn muốn mua vào bên dưới</small>
                </div>
                    ...
                    <div class="card-body p-4">
                        <div class="">
                            ...
                            <?php foreach($_inv as $k=> $v): ?>
                                <span><b>Giá sản phẩm: </b><?php echo $v ?></span>
                            <?php endforeach; ?>
